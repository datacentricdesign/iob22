...
To get started with this second tutorial, we propose to experience the principles
 ...
 the examples we compiled for the BNO055: [Orientation Sensor](https://github.com/datacentricdesign/code/blob/master/examples/sensors/orientation)
...
![]({{site.baseurl}}/assets/images/library.png)
...
<a href="https://github.com/datacentricdesign/code/blob/master/examples/communication/bluetooth/bno055_gatt_orientation" target="_blank">examples /
...
![]({{site.baseurl}}/assets/images/ws2_feather_bno055_wiring.png)
...
![blescan]({{site.baseurl}}/assets/images/ws2_blescan.png)
...
<a href="https://github.com/datacentricdesign/code/blob/master/examples/communication/bluetooth/subscribe_gatt_orientation.py" target="_blank">examples /
communication / bluetooth / bno055_gatt</a>
