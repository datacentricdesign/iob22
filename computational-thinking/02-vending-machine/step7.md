...
The following code does not always serve the right beverage. This vending machine is supposed serve coffee, tea, hot chocolate, cappuccino, and decaf coffee. But for some reason is only serves coffee. 
